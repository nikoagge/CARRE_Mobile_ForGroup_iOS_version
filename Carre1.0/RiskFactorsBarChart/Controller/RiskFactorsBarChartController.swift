...
class RiskFactorsBarChartController: UIViewController {
    ...
    var riskEvidencesHasRiskFactorAssociationTypeMatched = [String]()
    var riskElementsId = [String]()
    var riskElementsName = [String]()
    var riskFactorsSourceValuesForPickerView = [String]()
    var riskFactorsAssociationTypeIsAnIssueIn = [Double]()
    var riskFactorsAssociationTypeCauses = [Double]()
    var riskFactorsAssociationTypeReduces = [Double]()
    var riskFactorsAssociationTypeElevates = [Double]()
